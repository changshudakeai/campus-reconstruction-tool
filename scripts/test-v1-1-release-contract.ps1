...
Assert-Contains $durabilityEvidence 'ReliabilityCycles = 120' "Installed reliability evidence must default to 120 durable reopen cycles"
Assert-Contains $durabilityEvidence 'Formal installed reliability evidence requires at least 120 cycles' "Short development runs must not become formal evidence"
