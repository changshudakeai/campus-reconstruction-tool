...
fn every_emitted_text_key_resolves_in_zh_cn() {
    ...
    let keys = [
        ...
        text_keys::SUGGESTION_FILTERS_LABEL,
        text_keys::SUGGESTION_FILTER_TAB,
        text_keys::FILTER_NEEDS_ATTENTION,
        text_keys::FILTER_UNNAMED,
        text_keys::FILTER_SUGGEST_KEEP,
        text_keys::FILTER_HUMAN_REVIEW,
        text_keys::FILTER_SUGGEST_REMOVE,
