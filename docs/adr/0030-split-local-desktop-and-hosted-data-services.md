...
Hosted services own large or frequently changing shared datasets: bounded OSM and Overture queries and cache, application/model release manifests, and optional reviewed community annotations. Services return source records and provenance rather than generated schematics. The V1.1 desktop never queries public Overpass directly; user-configured Gaode access remains local and is never proxied through the hosted service.
