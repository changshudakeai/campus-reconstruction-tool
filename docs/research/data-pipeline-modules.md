...
> **后续决策（2026-08-01）**：本文是 ADR-0037/0039 之前的候选模块研究。文中的“S1 业务编排”已经失效；S1 只承担呈现与构造期接线，跨功能采集操作由 A1 `collection-flow` 拥有。模块职责与本文冲突时以 ADR-0037/0039 和 `docs/module-decisions.md` 为准。
