...
use desktop_shell::{
    assemble_application, AppWindow, CampusData, CampusPlanPageState, CampusPlanPresentationEntry,
    CollectionPageState, CollectionPresentationEntry, ConfirmationPresentation, CoveragePageState,
    CoveragePresentationEntry, ExportPageState, ExportPresentationEntry, NavigationDecision,
    NoticeData, NotificationFact, NotificationPageState, NotificationPresentationEntry,
    OpaqueNotificationAction, OperationPresentationState, PlanCardData, Presentation,
